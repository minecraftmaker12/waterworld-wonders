...
import net.mcreator.waterworldwonders.entity.CyantippedFanfishEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class CyantippedFanfishRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(CyantippedFanfishEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelcyan_tipped_fanfish(), 0.5f) {
					{
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("waterworld_wonders:textures/a.png");
					}
				};
			});
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn.getBuffer(RenderType.getEyes(new ResourceLocation("waterworld_wonders:textures/aeaea.png")));
