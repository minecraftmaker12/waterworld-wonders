...
package net.mcreator.waterworldwonders.world.biome;
...
public class CoralCoveBiome extends WaterworldWondersModElements.ModElement {
	public static Biome biome;

	public CoralCoveBiome(WaterworldWondersModElements instance) {
		super(instance, 14);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.DISK
								.withConfiguration(new SphereReplaceConfig(Blocks.GRAVEL.getDefaultState(), FeatureSpread.func_242253_a(2, 3), 2,
										ImmutableList.of(Blocks.SAND.getDefaultState(), Blocks.STONE.getDefaultState())))
				...
				event.getRegistry().register(biome.setRegistryName("waterworld_wonders:coral_cove"));
			}
		}
	}
