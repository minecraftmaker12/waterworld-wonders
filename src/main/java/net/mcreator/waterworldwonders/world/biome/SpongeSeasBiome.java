...
public class SpongeSeasBiome extends WaterworldWondersModElements.ModElement {
	public static Biome biome;

	public SpongeSeasBiome(WaterworldWondersModElements instance) {
		super(instance, 2);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("waterworld_wonders:sponge_seas"));
			}
		}
	}
