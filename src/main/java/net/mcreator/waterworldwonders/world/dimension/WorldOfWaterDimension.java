...
package net.mcreator.waterworldwonders.world.dimension;
...
import net.mcreator.waterworldwonders.item.WorldOfWaterItem;
...
public class WorldOfWaterDimension extends WaterworldWondersModElements.ModElement {
	@ObjectHolder("waterworld_wonders:world_of_water_portal")
	public static final CustomPortalBlock portal = null;

	public WorldOfWaterDimension(WaterworldWondersModElements instance) {
		super(instance, 5);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("waterworld_wonders:sponge_seas")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("waterworld_wonders:world_of_water"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("world_of_water_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("world_of_water_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())),
					0, 1).setRegistryName("world_of_water_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new WorldOfWaterItem().setRegistryName("world_of_water"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("world_of_water_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("waterworld_wonders:world_of_water"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("waterworld_wonders:world_of_water")));
				} else {
					entity.func_242279_ag();
	...
	public static class CustomPortalSize {
		private static final AbstractBlock.IPositionPredicate POSITION_PREDICATE = (state, blockReader, pos) -> {
			return state.getBlock() == Blocks.BLACKSTONE;
		};
